    ...
    new LocalStrategy(
      ...
      async (req, username, password, done) => {
        try {
          ...
          const cart = await cartsRepository.create(); //dentro de nuestra estrategia de usuario vamos a crear un carrito, que en el proceso de registro, en caso que no se cumpla la condicion anterior, creara un carrito
          ...
          const newUser = {
            ...
            role,
            cart: cart._id //el cart va a hacer referencia al id
          };
