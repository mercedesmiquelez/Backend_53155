...
router.get("/", async (req, res) => {
  try {
    ...
    if (status) {
      //Hacemos condicionales si hay filtros o no
    ...
    res
      .status(500)
      .json({ status: "Error", msg: "Error interno del servidor" }); //si hay un problema con el paginate o interno del servidor, le doy una rta al cliente
  }
});
